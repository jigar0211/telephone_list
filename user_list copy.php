        ...
        <div class="table-responsive">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    echo "<li class='page-item'><a class='page-link' href='?page={$prevPage}{$searchQuery}'>Previous</a></li>";
                    for ($i = 1; $i <= $totalPages; $i++) {
                        $activeClass = $page == $i ? 'active' : '';
                        echo "<li class='page-item {$activeClass}'><a class='page-link' href='?page={$i}{$searchQuery}'>{$i}</a></li>";
                    }
                    echo "<li class='page-item'><a class='page-link' href='?page={$nextPage}{$searchQuery}'>Next</a></li>";
                    ?>
                </ul>
            </nav>
        </div>
